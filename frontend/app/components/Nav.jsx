  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center border-b-[1px] border-gray-200 py-4 shadow-md bg-white">
      ...
      <div className="hidden sm:flex mr-10">
        <Link href="/">
          <span className="mx-3 text-sm sm:text-md cursor-pointer hover:border-yellow-400 hover:no-underline hover:font-semibold hover:border-b-2">
            Home
          </span>
        </Link>
        <Link href="/people">
        ...
        <Link href="/contactus">
          <span className="bg-black text-white rounded-lg hover:bg-white hover:text-black p-2 border-2 border-black mx-3 cursor-pointer">
            Contact
          </span>
        </Link>
      </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="relative bg-white border-2 border-black rounded-lg shadow-lg p-14">
            ...
            <div className="flex flex-col justify-center items-start">
              <Link href="/">
                <span className="block my-5 mx-5 mb-3 text-lg cursor-pointer font-semibold border-b-[1px] border-yellow-400">
                  Home
                </span>
              </Link>
              <Link href="/people">
